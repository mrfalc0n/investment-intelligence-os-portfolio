...
- [Cockpit And Status Model](docs/cockpit-and-status-model.md) - sanitized Notion/dashboard style operating model.
...
The architecture is designed around one blunt rule:
